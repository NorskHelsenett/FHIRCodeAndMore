...
* serviceType[0].coding[0].system = "http://helsenorge.no/fhir/CodeSystem/hn-schedule-type-cs"
* serviceType[=].coding[=].code = #Lab
* serviceType[=].coding[=].display = "Lab"
