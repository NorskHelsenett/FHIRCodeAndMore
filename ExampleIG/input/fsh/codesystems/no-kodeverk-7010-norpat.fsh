CodeSystem: NoKodeverk7010NORPAT
Id: no-kodeverk-7010-norpat.codesystem
Title: "Norsk patologikodeverk (NORPAT)."
...
//* ^url = "http://ehelse.no/fhir/CodeSystem/no-kodeverk-7010-norpat"
* ^experimental = false
* ^caseSensitive = true
* ^identifier.system = "urn:ietf:rfc:3986"
* ^identifier.value = "urn:oid:2.16.578.1.12.4.1.1.7010"
* ^status = #active
* ^publisher = "Den norske patologiforening"
* ^content = #not-present
