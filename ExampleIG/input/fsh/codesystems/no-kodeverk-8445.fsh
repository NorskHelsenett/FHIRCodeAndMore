CodeSystem: NoKodeverk8445
Id: no-kodeverk-8445.codesystem
Title: "8445 Ventetid sluttkode"
Description: "Dette kodeverket inneholder koder for avvikling."
* ^url = "http://ehelse.no/fhir/CodeSystem/no-kodeverk-8445"
* ^identifier.system = "urn:ietf:rfc:3986" 
* ^identifier.value = "urn:oid:2.16.578.1.12.4.1.1.8445"
* ^status = #active 
* ^date = "2022-03-17" //sist endret dato
