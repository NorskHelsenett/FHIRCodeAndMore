...
* ^url = "http://ehelse.no/fhir/CodeSystem/no-kodeverk-8432"
* ^identifier.system = "urn:ietf:rfc:3986" 
* ^identifier.value = "urn:oid:2.16.578.1.12.4.1.1.8432"
* ^status = #active 
* ^date = "2021-10-04" //sist endret dato
